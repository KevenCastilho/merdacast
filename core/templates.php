...
//	$theme_file_contents = str_replace("-----PG_MENUARCHIVE-----", _("Podcast Archive"), $theme_file_contents); 
	...
	$definefooter = _("Powered by").' <a href="https://www.facebook.com/keven.castilho" title="'._("Keven Castilho")._(", em parceiria com Mekinino Alvez.").'">'._("Keven Castilho").'</a>'._(", em parceiria com Mekinino Alvez.");
